...
namespace WeatherPortal.Data.Migrations
{
    ...
    public partial class Second : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SatelliteRadarImages",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ImageType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhenReadAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SatelliteRadarImages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeatherStations_Townships_TownshipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeatherStations_TownshipId",
                table: "WeatherStations",
                column: "TownshipId");
        }
